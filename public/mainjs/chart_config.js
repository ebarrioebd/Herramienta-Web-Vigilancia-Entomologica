...
gradient.addColorStop(0, "rgba(254,20,0,0.9)")
gradient.addColorStop(0.1, "rgba(254,70,0,0.9)") 
gradient.addColorStop(0.6, "rgba(204,160,0,0.7)")
gradient.addColorStop(0.7, "rgba(123,180,0,0.9)")
gradient.addColorStop(0.8, "rgba(153,199,0,0.9)")
gradient.addColorStop(0.9, "rgba(123,220,0,0.9)")
